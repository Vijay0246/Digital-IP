locals {
  ...
  jcasc_ami = local.project_vars.locals.jcasc_ami
  jcasc_instance_type = local.project_vars.locals.jcasc_instance_type
...
inputs = {
    ...
    jcasc_ami = local.jcasc_ami
    jcasc_instance_type = local.jcasc_instance_type
