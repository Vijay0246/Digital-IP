locals {
  ...
  bastion_host_ami  = local.project_vars.locals.bastion_host_ami
  bastion_instance_type = local.project_vars.locals.bastion_instance_type
...
inputs = {
    ...
    bastion_host_ami  = local.bastion_host_ami
