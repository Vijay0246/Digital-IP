locals {
  ...
  jfrog_ami = local.project_vars.locals.jfrog_ami
  jfrog_instance_type = local.project_vars.locals.jfrog_instance_type
...
inputs = {
    ...
    jfrog_ami = local.jfrog_ami
    jfrog_instance_type = local.jfrog_instance_type
