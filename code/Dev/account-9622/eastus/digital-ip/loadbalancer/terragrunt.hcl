locals {
  ...
  project_vars                    = read_terragrunt_config(find_in_parent_folders("project.hcl"))
    lb_name                       = local.project_vars.locals.lb_name
    lb_pip_name                   = local.project_vars.locals.lb_pip_name
    lb_frontend_ip_configuration  = local.project_vars.locals.lb_frontend_ip_configuration
...
inputs = {
    ...
    lb_pip_name                    = local.lb_pip_name
    lb_frontend_ip_configuration   = local.lb_frontend_ip_configuration
